...
module Zeitwerk::ExplicitNamespace
  ...
  def self.__registered?(cname_or_cpath); end
  def self.__unregister_loader(loader); end
  def self.clear; end
  def self.loader_for(mod, cname); end
  def self.register(cref, loader); end
  def self.registered?(cname_or_cpath); end
  def self.unregister_loader(loader); end
end
module InvalidName___Class_0x00___Synchronized_1
  def __clear; end
  def __loader_for(*, **, &); end
  def __register(*, **, &); end
  def __registered?(*, **, &); end
  def __unregister_loader(*, **, &); end
  def clear; end
  def loader_for(*, **, &); end
  def register(*, **, &); end
  def registered?(*, **, &); end
  def unregister_loader(*, **, &); end
  extend Zeitwerk::Internal
end
